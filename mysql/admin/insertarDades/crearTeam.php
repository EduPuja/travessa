                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-4 mt-md-4 pb-5">
                                ...
                                <form class="from-control" action="assets_gestioPartits/insertPartits.php" method="post">
					            	...
					            	<div class="form-outline form-white mb-4">
                                        <input type="text" name="pais" id="pais" class="form-control form-control-lg" placeholder="Pais" required/>
                                    </div>
                                    <button class="btn btn-outline-secondary btn-sm px-4 mb-5" type="submit">Crear Equip</button>
                                </form>
