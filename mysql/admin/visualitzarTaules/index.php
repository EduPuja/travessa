...
<head>
    ...
    <title>Visualitzar Taules</title>
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-4 mt-md-4 pb-5">
                                ...
                                <button type="button"  class="btn btn-outline-primary" onclick="  location.href = 'visualitzarJugadors.php'">TAULA JUGADORS</button><br><br>
                                <button type="button"  class="btn btn-outline-primary" onclick="  location.href = 'visualitzarApostes.php'">TAULA APOSTES USUARIS</button><br><br>
